export const books = [
  ...
  
  {
      ...
      image: "https://th.bing.com/th/id/OIP.zmimrFHYhcTGzEyOu50GuwAAAA?w=115&h=180&c=7&r=0&o=5&pid=1.7",
    ...
    },
    {
      ...
      category: "Marketing",
      description: "An exploration of the principles of persuasion and why people say 'yes'. Drawing on extensive research and real-world examples, the author identifies the key factors that influence our decisions, including reciprocity, commitment, social proof, authority, liking, and scarcity. This insightful book not only reveals how these principles can be used ethically in marketing but also helps readers recognize when they are being influenced."
    },
    {
...

    {
      ...
      category: "Business",
      description: "Examines the qualities that allow some companies to excel over their competitors. Through rigorous research and analysis, the author identifies key characteristics of companies that made the leap from good to great, including disciplined people, disciplined thought, and disciplined action. This book provides a roadmap for leaders aiming to transform their organizations and achieve sustained excellence in their fields."
    },
    {
  ...
  // Category 3: Self-Development

    {
      ...
      description: "This transformative guide explores the intricacies of habit formation and offers a framework for making small changes that lead to remarkable results, emphasizing the power of incremental improvements."
    },
    {
      ...
      category: "Self-Development",
      description: "This insightful work delves into the science of habit formation, offering an analysis of the neurological underpinnings of behavior and practical strategies for leveraging habits to foster personal and professional growth."
    },
    {
      ...
      category: "Self-Development",
      description: "This seminal work introduces the concept of 'fixed' vs. 'growth' mindsets, providing profound insights into how one's beliefs about their abilities can significantly influence their success and resilience."
    },
    {
      ...
      category: "Self-Development",
      description: "In this compelling narrative, the author examines the critical role of grit—passion and perseverance—in achieving long-term goals, supported by extensive research and personal anecdotes."
    },
    {
      ...
      category: "Stories",
      description: "A poignant exploration of racial injustice and moral growth in the Deep South, this classic novel is narrated through the innocent eyes of a young girl, providing profound social commentary."
    },
    {
      ...
      category: "Stories",
      description: "George Orwell's dystopian novel serves as a powerful warning against totalitarianism, exploring themes of surveillance, individuality, and the manipulation of truth in a chilling future society."
    },
    {
      ...
      keywords: ["fiction", "classic", "literature"],
      category: "Stories",
      description: "Set in the Roaring Twenties, this novel captures the essence of the American Dream through the tragic tale of Jay Gatsby, weaving themes of love, wealth, and societal disillusionment."
    },
    {
      ...
      category: "Stories",
      description: "This beloved classic delves into themes of love, class, and reputation, following the spirited Elizabeth Bennet as she navigates the complexities of societal expectations and personal desires."
    },
    {
      ...
      keywords: ["fiction", "classic", "literature"],
      category: "Stories",
      description: "A profound exploration of teenage angst and alienation, this novel follows Holden Caulfield as he navigates a world of phoniness and seeks authentic connections in the bustling city of New York."
    }
